...
- **[Web board](docs/guide.en.md#web-board-board-command)** — read-only kanban + quota burndown + goal-anchored "landed progress", with insufficient data always disclosed rather than estimated.
