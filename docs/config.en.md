...
| `fallback_order` | ["codex"] | divert order during claude cooldown/redline ("codex" and engine names interleaved, first available wins); quality floors (`no_fallback_models`/cross cards/review slots) apply to every entry |
