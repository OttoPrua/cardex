...
Last updated: 2026-08-14 03:14 +08:00
...
- Current installed binary: version `0.10.2`, SHA-256 `e82235e4b9a60ff91ba227f6caaa847f7025923949cb9bba25557742a64ed8eb`, base revision `29f3e9694d9501bff2d0c038dea6b39fb15cb92a`, `vcs.modified=true`.
- Uninstalled v2 reference candidate: commit `1d22f2c6984223a7e6db5ad0533ae2b11f1e70db`, SHA-256 `39339a4167462e69426f63bd7211b7df1e1b0e1d95957b0ac0a52478b8d8c4a1`; install preflight passed read-only against current production preimage `e822…`. Do **not** install it directly: current production `0.10.2` also contains later Kimi/OpenCode/routing changes from the separate dirty main worktree that this branch does not contain. First establish a clean committed authority for those live feature bytes, integrate the retrospective/install commits, and test that combined candidate so recovery does not regress active runner capabilities.
...
- Board service: `com.cardex.board`, PID `81288`, bind `0.0.0.0:8788`, health version `0.10.2`; currently running the drifted inode.
- Scheduler service: `com.cardex.tick`, path `/opt/homebrew/bin/cardex`, 300-second interval, latest observed exit code 0. It currently resolves to the drifted inode; no re-registration receipt for that replacement was found.
